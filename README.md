...
index 0000000000000000000000000000000000000000..a8a8a14e03db95acdda762758815f0c243778267
--- /dev/null
+++ b/README.md
@@ -0,0 +1,82 @@
...
+## ライセンス / 注意事項
+
+- モデルファイル（`.mlpackage`）や音声素材の取り扱いは、配布元ライセンスを確認してください。
+- 公共空間での利用時は、周囲の安全・プライバシーへ十分配慮してください。
+
+---
+
+必要であれば次のステップとして、`README` に **Xcode プロジェクトファイル名**や**スクリーンショット**、**開発・実験ログの書き方**も追加できます。
